...
The features described in the above description have all been implemented in the webpage and are described in more detail here with screenshots of the webpage for context

!["Default webpage values"](/README_Images/WebPage_Default_Values.png)